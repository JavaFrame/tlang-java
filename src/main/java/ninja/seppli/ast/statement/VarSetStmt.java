...
/**
 * a variable assignment (like var1 := 2;)
 * @author sebi
 *
 */
public class VarSetStmt implements Statement {
	/**
	 * the id
	 */
	 ...
	 */
	public VarSetStmt(IdentifierToken id, Expression expr) {
		this.id = id;
		this.expr = expr;
	}
	...
	public boolean equals(Object obj) {
		...
		VarSetStmt other = (VarSetStmt) obj;
		if (expr == null) {
			if (other.expr != null) {
				return false;
			}
